package com.kuquo.app.front.action;

import com.kuquo.app.baseInfo.area.model.Area;
import com.kuquo.app.baseInfo.area.service.AreaService;
import com.kuquo.app.baseInfo.delivery.model.Delivery;
import com.kuquo.app.baseInfo.delivery.service.DeliveryService;
import com.kuquo.app.baseInfo.payment.model.Payment;
import com.kuquo.app.baseInfo.payment.service.PaymentService;
import com.kuquo.app.component.file.model.FileUpload;
import com.kuquo.app.component.file.service.FileUploadService;
import com.kuquo.app.component.serialNumber.service.SerialNumberService;
import com.kuquo.app.customer.model.Customer;
import com.kuquo.app.customer.model.CustomerAddress;
import com.kuquo.app.customer.service.CustomerAddressService;
import com.kuquo.app.customer.service.CustomerService;
import com.kuquo.app.front.browse.model.Browse;
import com.kuquo.app.front.browse.model.BrowseBuy;
import com.kuquo.app.front.browse.service.BrowseBuyService;
import com.kuquo.app.front.browse.service.BrowseService;
import com.kuquo.app.front.model.GoodsInCar;
import com.kuquo.app.front.model.ShoppingCar;
import com.kuquo.app.front.model.WareComment;
import com.kuquo.app.front.service.FrontGoodService;
import com.kuquo.app.front.service.WareCommentService;
import com.kuquo.app.good.favorite.model.Favorite;
import com.kuquo.app.good.favorite.service.FavoriteService;
import com.kuquo.app.good.good.model.Good;
import com.kuquo.app.good.good.service.GoodService;
import com.kuquo.app.good.goodAttr.model.GoodAttr;
import com.kuquo.app.good.goodAttr.service.GoodAttrService;
import com.kuquo.app.good.goodBrand.model.GoodBrand;
import com.kuquo.app.good.goodBrand.service.GoodBrandService;
import com.kuquo.app.good.goodCompose.model.GoodCompose;
import com.kuquo.app.good.goodCompose.service.GoodComposeService;
import com.kuquo.app.good.goodExtend.model.GoodExtend;
import com.kuquo.app.good.goodExtend.service.GoodExtendService;
import com.kuquo.app.good.goodKind.model.GoodKind;
import com.kuquo.app.good.goodKind.model.GoodKingVal;
import com.kuquo.app.good.goodKind.service.GoodKindService;
import com.kuquo.app.good.goodKind.service.GoodKingValService;
import com.kuquo.app.good.goodPrice.model.GoodPrice;
import com.kuquo.app.good.goodPrice.service.GoodPriceService;
import com.kuquo.app.good.goodRelate.model.GoodRelate;
import com.kuquo.app.good.goodRelate.service.GoodRelateService;
...
import com.kuquo.app.good.goodSpecification.service.GoodSpecificationService;
import com.kuquo.app.good.goodSpecification.service.GoodSpecificationValService;
import com.kuquo.app.good.goodType.model.GoodType;
import com.kuquo.app.good.goodType.service.GoodTypeService;
import com.kuquo.app.good.ware.model.Ware;
import com.kuquo.app.good.ware.model.WareSpecificationVal;
import com.kuquo.app.good.ware.service.WareService;
import com.kuquo.app.good.ware.service.WareSpecificationValService;
import com.kuquo.app.order.sale.saleOrder.model.SaleOrder;
import com.kuquo.app.order.sale.saleOrder.service.SaleOrderService;
import com.kuquo.app.order.sale.saleWare.model.SaleWare;
import com.kuquo.app.order.sale.saleWare.service.SaleWareService;
import com.kuquo.app.store.advertise.model.Advertise;
import com.kuquo.app.store.advertise.service.AdvertiseService;
import com.kuquo.app.store.information.model.Information;
import com.kuquo.app.store.information.service.InformationService;
import com.kuquo.app.store.promote.model.Promote;
import com.kuquo.app.store.promote.model.PromoteGood;
import com.kuquo.app.store.promote.service.PromoteGoodService;
import com.kuquo.app.store.promote.service.PromoteService;
import com.kuquo.app.vip.coupon.model.VipCoupon;
import com.kuquo.app.vip.coupon.service.VipCouponService;
import com.kuquo.app.vip.message.model.Message;
import com.kuquo.app.vip.message.service.MessageService;
import com.kuquo.app.warehouse.warehouse.model.Warehouse;
import com.kuquo.app.warehouse.warehouse.service.WarehouseService;
