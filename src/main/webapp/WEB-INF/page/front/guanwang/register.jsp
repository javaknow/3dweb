...
<!--   <h2><img src="${ctx}/Images/images/y30.jpg" /></h2>-->
  ...
  <div class="login0202_text2">
   <div class="login0202_text201"><input style="cursor:text" id="agreeRegister" disabled="true" name="" type="button"  class="login0202_text1btn" value="同意协议并注册" onclick="submitRegisterForm()"/></div>
  ...
  本协议是您与上理在线学院所有者之间就京东商城网站服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击“同意以下协议，提交”按钮后，本协议即构成对双方有约束力的法律文件。<br />
  第1条 本站服务条款的确认和接纳<br />
